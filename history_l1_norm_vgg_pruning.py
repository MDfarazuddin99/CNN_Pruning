...
class cifar10vgg:
    ...
    def __init__(self,first_time,epochs,train=True):
        ...
        if train:
            ...
            #change
            self.model.load_weights('/content/drive/My Drive/Colab Notebooks/best_cifarvgg.h5')
...
if choice == 'Y':
    ...
    my_vgg = cifar10vgg(first_time=True,epochs=5)
    model, history ,weight_list_per_epoch= my_vgg.model, my_vgg.history, my_vgg.weight_list_per_epoch
    model.save('/content/drive/My Drive/Colab Notebooks/best_cifarvgg.h5')
...
#change
log_df.to_csv('/content/drive/My Drive/exp_1_RESULT_VGG_HISTORY_L1_PRUNING.csv')
