...
# for i in range(len(all_conv_layers)):
#     print(layer_indexes[i],i)
#     model_new = delete_channels(my_model,my_model.layers[layer_indexes[i]],layer_wise_filter_sorted[i][0:prune_filter_indices[i]])


# layer_0 = my_model.layers[0]
# model_new = delete_channels(my_model,my_model.layers[0],layer_wise_filter_sorted[0][0:prune_filter_indices[0]])




# layer_3 = model_new.layers[3]
# model_new = delete_channels(model_new,layer_3,layer_wise_filter_sorted[1][0:prune_filter_indices[1]])

# layer_5 = model_new.layers[5]
# model_new = delete_channels(model_new,layer_5,layer_wise_filter_sorted[2][0:prune_filter_indices[2]])


# print(model_new.layers[1].get_weights()[0].shape)
...
# surgeon.add_job('delete_channels',my_model.layers[1],channels=layer_wise_filter_sorted[][0:prune_filter_indices[1]])
# surgeon.add_job('delete_channels',my_model.layers[4],channels=layer_wise_filter_sorted[2][0:prune_filter_indices[2]])
# surgeon.add_job('delete_channels',my_model.layers[5],channels=layer_wise_filter_sorted[3][0:prune_filter_indices[3]])
